...
class BaseClient():
    ...
    def init_params(self):
        ...
        self.auxiliary_batch_size = int(self.nn_config["auxiliary_batch_size"])
        ...
        self.num_labels=int(self.nn_config["num_labels"])
        self.loss_type=str(self.nn_config["loss_type"])
    ...
    def init_model_checkpoint(self):
        home = str(Path.home())
        os.getcwd()
        model_checkpoint = path.join(home, ".code_ood" ,"model_checkpoint", self.version, self.model_name)
